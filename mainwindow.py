...
class MainWindow(QMainWindow):
    ...
    def __init__(self, data_source, data_proc, settings_control, bpm_name):
        ...
        self.data_curve1 = self.ui.plotI.plot(pen='r', title='Current_plot')
        self.data_curve2 = self.ui.plotI.plot(pen='b', title='Current_plot')
        self.data_curve3 = self.ui.plotI.plot(pen='k', title='Current_plot')
        self.data_curve4 = self.ui.plotI.plot(pen='y', title='Current_plot')
